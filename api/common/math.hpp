...
inline double pow10( int iPower )
{
    switch( iPower )
    {
        case 20:    return 100000000000000000000.0;
        case 19:    return 10000000000000000000.0;
        case 18:    return 1000000000000000000.0;
        case 17:    return 100000000000000000.0;
        ...
        default:    return std::pow( 10.0, iPower );
    }
}
...
unsigned int getXFrom3dIndex( T1 sizeX, T2 sizeY, T3 index )
{
    return static_cast< unsigned int >( index ) % static_cast< unsigned int >( sizeX );
}
...
{
    return ( static_cast< unsigned int >( index ) / static_cast< unsigned int >( sizeX ) ) % static_cast< unsigned int >( sizeY );
}
