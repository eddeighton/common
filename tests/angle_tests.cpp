...
TEST( DiscreteAngle, toVectorDiscrete_16_float )
{
    ...
    typedef Angle< 16 > A;
    VectorType r;
    toVectorDiscrete< A, float >( A::eEast         , r.first, r.second ); ASSERT_EQ( VectorType( 1.0f   , 0.0f  ), r );
    toVectorDiscrete< A, float >( A::eSouthEast    , r.first, r.second ); ASSERT_EQ( VectorType( 1.0f   , -1.0f ), r );
    toVectorDiscrete< A, float >( A::eSouth        , r.first, r.second ); ASSERT_EQ( VectorType( 0.0f   , -1.0f ), r );
    toVectorDiscrete< A, float >( A::eSouthWest    , r.first, r.second ); ASSERT_EQ( VectorType( -1.0f  , -1.0f ), r );
    toVectorDiscrete< A, float >( A::eWest         , r.first, r.second ); ASSERT_EQ( VectorType( -1.0f  , 0.0f  ), r );
    toVectorDiscrete< A, float >( A::eNorthWest    , r.first, r.second ); ASSERT_EQ( VectorType( -1.0f  , 1.0f  ), r );
    toVectorDiscrete< A, float >( A::eNorth        , r.first, r.second ); ASSERT_EQ( VectorType( 0.0f   , 1.0f  ), r );
    toVectorDiscrete< A, float >( A::eNorthEast    , r.first, r.second ); ASSERT_EQ( VectorType( 1.0f   , 1.0f  ), r );
}
TEST( DiscreteAngle, toVectorDiscrete_16_double )
{
    ...
    typedef Angle< 16 > A;
    VectorType r;
    toVectorDiscrete< A, double >( A::eEast         , r.first, r.second ); ASSERT_EQ( VectorType( 1.0   , 0.0  ), r );
    toVectorDiscrete< A, double >( A::eSouthEast    , r.first, r.second ); ASSERT_EQ( VectorType( 1.0   , -1.0 ), r );
    toVectorDiscrete< A, double >( A::eSouth        , r.first, r.second ); ASSERT_EQ( VectorType( 0.0   , -1.0 ), r );
    toVectorDiscrete< A, double >( A::eSouthWest    , r.first, r.second ); ASSERT_EQ( VectorType( -1.0  , -1.0 ), r );
    toVectorDiscrete< A, double >( A::eWest         , r.first, r.second ); ASSERT_EQ( VectorType( -1.0  , 0.0  ), r );
    toVectorDiscrete< A, double >( A::eNorthWest    , r.first, r.second ); ASSERT_EQ( VectorType( -1.0  , 1.0  ), r );
    toVectorDiscrete< A, double >( A::eNorth        , r.first, r.second ); ASSERT_EQ( VectorType( 0.0   , 1.0  ), r );
    toVectorDiscrete< A, double >( A::eNorthEast    , r.first, r.second ); ASSERT_EQ( VectorType( 1.0   , 1.0  ), r );
}
TEST( DiscreteAngle, toVectorDiscrete_16_int )
{
    ...
    typedef Angle< 16 > A;
    VectorType r;
    toVectorDiscrete< A, int >( A::eEast         , r.first, r.second ); ASSERT_EQ( VectorType( 1   , 0  ), r );
    toVectorDiscrete< A, int >( A::eSouthEast    , r.first, r.second ); ASSERT_EQ( VectorType( 1   , -1 ), r );
    toVectorDiscrete< A, int >( A::eSouth        , r.first, r.second ); ASSERT_EQ( VectorType( 0   , -1 ), r );
    toVectorDiscrete< A, int >( A::eSouthWest    , r.first, r.second ); ASSERT_EQ( VectorType( -1  , -1 ), r );
    toVectorDiscrete< A, int >( A::eWest         , r.first, r.second ); ASSERT_EQ( VectorType( -1  , 0  ), r );
    toVectorDiscrete< A, int >( A::eNorthWest    , r.first, r.second ); ASSERT_EQ( VectorType( -1  , 1  ), r );
    toVectorDiscrete< A, int >( A::eNorth        , r.first, r.second ); ASSERT_EQ( VectorType( 0   , 1  ), r );
    toVectorDiscrete< A, int >( A::eNorthEast    , r.first, r.second ); ASSERT_EQ( VectorType( 1   , 1  ), r );
}
...
TEST( DiscreteAngle, toVectorDiscrete_4_double )
{
    ...
    typedef Angle< 4 > A;
    VectorType r;
    toVectorDiscrete< A, double >( A::eEast         , r.first, r.second ); ASSERT_EQ( VectorType( 1.0f   , 0.0f  ), r );
    toVectorDiscrete< A, double >( A::eSouth        , r.first, r.second ); ASSERT_EQ( VectorType( 0.0f   , -1.0f ), r );
    toVectorDiscrete< A, double >( A::eWest         , r.first, r.second ); ASSERT_EQ( VectorType( -1.0f  , 0.0f  ), r );
    toVectorDiscrete< A, double >( A::eNorth        , r.first, r.second ); ASSERT_EQ( VectorType( 0.0f   , 1.0f  ), r );
}
